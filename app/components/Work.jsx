      ...
      >
        {displayedProjects.map((project, index) => (
          <motion.div
            ...
            key={index}
            className='font-body bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col'
          >
            ...
            <div className='p-4 flex flex-col flex-grow'>
              ...
              <div className='flex gap-2 mt-auto pt-3 border-t border-gray-200 dark:border-gray-700'>
                <a 
                  ...
                  className='flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-[#1a365d] dark:bg-cyan-600 text-white rounded-lg hover:bg-[#234681] dark:hover:bg-cyan-500 transition-colors text-xs font-bold shadow-sm'
                >
